...
const ButtonContained = (props: IProps) => {
  return (
    <button
      ...
      className={`px-4 py-1 rounded flex flex-row justify-center items-center w-auto cursor-pointer select-none shadow-normal ${props?.type === 'primary' ? 'bg-blue' : 'bg-white'}`}
    >
