...
const ButtonOutlined = (props: IProps) => {
  return (
    <button
      ...
      className={`px-4 py-1 rounded border flex flex-row justify-center items-center w-auto cursor-pointer select-none ${props?.type === 'primary' ? 'border-blue' : 'border-white'}`}
    >
